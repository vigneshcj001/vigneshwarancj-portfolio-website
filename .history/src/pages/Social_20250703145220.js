...
const socialLinks = [
  {
    name: "LinkedIn",
    url: LINKEDIN_LINK,
    icon: <FaLinkedin className="w-12 h-12 text-white group-hover:scale-110 group-hover:-rotate-6 transition-transform" />,
  ...
  },
  {
    name: "Instagram",
    url: INSTAGRAM_LINK,
    icon: <FaInstagram className="w-12 h-12 text-white group-hover:scale-110 group-hover:rotate-6 transition-transform" />,
  ...
  },
  {
    name: "GitHub",
    url: GITHUB_LINK,
    icon: <FaGithub className="w-12 h-12 text-white group-hover:scale-110 group-hover:-rotate-6 transition-transform" />,
  ...
  },
  {
    name: "X (Twitter)",
    url: X_LINK,
    icon: <FaXTwitter className="w-12 h-12 text-white group-hover:scale-110 group-hover:rotate-6 transition-transform" />,
  ...
  },
  {
    name: "YouTube",
    url: YOUTUBE_LINK,
    icon: <FaYoutube className="w-12 h-12 text-white group-hover:scale-110 group-hover:-rotate-6 transition-transform" />,
  ...
  },
  {
    ...
    icon: <SiBuymeacoffee className="w-12 h-12 text-white group-hover:scale-110 group-hover:rotate-6 transition-transform" />,
