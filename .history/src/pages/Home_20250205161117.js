...
const skills = [
  "JavaScript", "React", "Node.js", "CSS", "HTML", "Python", "Django", "Machine Learning", "Data Science", 
  "SQL", "Java", "C++", "TypeScript", "Git", "AWS", "Docker", "Kubernetes", "GraphQL", "Firebase", 
  "PostgreSQL", "Ruby", "GitHub", "Bootstrap", "Swift", "Android Development", "iOS Development", "NoSQL", 
  "Flask", "Vue.js", "TensorFlow", "PyTorch", "MySQL", "Terraform", "Jenkins", "Power BI", "Tableau", 
  "Ansible", "Google Cloud", "Azure", "RESTful APIs", "Cloud Computing", "Security Best Practices", "Linux", 
  "DevOps", "CI/CD", "Agile/Scrum", "JIRA", "Unit Testing", "Sass", "Tailwind CSS", "WordPress", "SEO Optimization", 
  "Vim", "Docker Compose", "Hadoop", "Apache Spark", "NLP", "Computer Vision", "Blockchain", "Cryptography", 
  "Penetration Testing", "Ethical Hacking", "ElasticSearch", "Web Security", "MongoDB", "Redis", "WebSockets", 
  "Socket.io", "Figma", "UX/UI Design", "Google Analytics"
];
