          ...
          >
            ...
            {project.link ? (
              project.link.startsWith("/") ? (
                <Link
                  to={project.link}
                  className="mt-4 inline-block bg-white text-gray-800 font-semibold px-4 py-2 rounded-lg shadow-md transition hover:bg-gray-200 dark:bg-gray-100 dark:text-gray-900 dark:hover:bg-gray-300"
                >
                  View Project
                </Link>
              ) : (
