...
const Home = () => {
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center bg-gradient-to-r from-[#2E3192] via-[#1BFFFF] to-[#1B1464] dark:bg-gradient-to-r dark:from-[#0F2027] dark:via-[#203A43] dark:to-[#2C5364] text-white overflow-hidden">
      {/* Prevent white edges */}
      <style>{`
        body, html {
          margin: 0;
