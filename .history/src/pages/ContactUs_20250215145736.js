...
const ContactUs = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-8 bg-gray-100 dark:bg-gray-800 rounded-lg shadow-2xl border border-gray-300 dark:border-gray-600 flex justify-center">
