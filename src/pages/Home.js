...
export default function Home() {
  ...
  return <div className="home-page">
    <section className="portfolio-section hero-section">
      <div><p className="eyebrow">AI / ML engineer · Full-stack developer</p><h1>Useful software.<br /><span>Thoughtful AI.</span></h1><p className="lead">I’m Vigneshwaran C. J. I build web, desktop, and AI products that turn complex workflows into usable software—from browser agents and developer networking to computational biology.</p>
    ...
    <div className="portfolio-section stats-strip"><span><b>{projects.length}</b> selected projects</span><span><b>{skillCategories.reduce((sum, c) => sum + c.skills.length, 0)}</b> technologies</span><span><b>Web + Desktop + AI + Bio</b> connected expertise</span></div>
