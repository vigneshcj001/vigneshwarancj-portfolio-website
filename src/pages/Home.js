...
const SKILL_BUBBLES = [
  ...
  { name: "Socket.IO",    abbr: "SK", cat: "Backend"    },
  { name: "Streamlit",    abbr: "ST", cat: "Backend"    },
  { name: "n8n",          abbr: "N8", cat: "Tools"      },
  { name: "SHAP",         abbr: "SH", cat: "ML/AI"      },
  { name: "RDKit",        abbr: "RD", cat: "Research"   },
  { name: "Mordred",      abbr: "MR", cat: "Research"   },
...
const SKILLS_MARQUEE = [
  ...
  "Groq", "n8n", "RDKit", "Socket.IO", "SHAP", "DynamoDB",
];
