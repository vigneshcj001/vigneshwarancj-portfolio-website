...
const Skills = () => {
  const skillCategories = {
    ...
    "AI & LLMs": [
      {
        name: "GPT-4",
        icon: <SiOpenai className="text-gray-800 dark:text-white" />,
      },
    ...
    "Tools & Others": [
      ...
      {
        name: "Linux",
        icon: <SiLinux className="text-black dark:text-white" />,
      },
  ...
  return (
    <section className="w-full max-w-6xl mx-auto py-12">
      <h2 className="text-4xl font-bold mb-10 text-center mt-12 pt-6">
        🚀 Skills
      </h2>
